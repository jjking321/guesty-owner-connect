...
/**
 * Airbnb mark (inline SVG). Uses currentColor for theming.
 */
export function AirbnbIcon({ className, title = "Airbnb", ...props }: Props) {
  return (
    <svg
      viewBox="0 0 94 100"
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M91.5,71c-0.5-1.2-1-2.5-1.5-3.6c-0.8-1.8-1.6-3.5-2.3-5.1l-0.1-0.1
