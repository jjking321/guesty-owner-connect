-- Create function to get aggregated review statistics
...
BEGIN
  ...
  rating_counts AS (
    SELECT
      ...
      COUNT(*) FILTER (WHERE ROUND(rating) = 1) AS r1,
      COUNT(*) FILTER (WHERE ROUND(rating) = 2) AS r2,
      COUNT(*) FILTER (WHERE ROUND(rating) = 3) AS r3,
      COUNT(*) FILTER (WHERE ROUND(rating) = 4) AS r4,
      COUNT(*) FILTER (WHERE ROUND(rating) = 5) AS r5
